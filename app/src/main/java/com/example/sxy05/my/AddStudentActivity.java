...
public class AddStudentActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        dao = new StudentDao(new DBHelper(this)); // 设置监听 78
    ...
    private void checkIsAddStudent() {
        ...
        if (serial == null) {
            ...
            isAdd = false;
            StudentItem s = (StudentItem) serial;
            showEditUI(s);
        }
    }
    //显示学员信息更新的UI104
    private void showEditUI(StudentItem student) {
    ...
    public void onClick(View v) {
        ...
        if (v == restoreButton) {
            ...
            StudentItem student = getStudentFromUI();
            if (isAdd) {
    ...
    private StudentItem getStudentFromUI() {
        ...
        StudentItem s=new StudentItem(name, age, sex, likes, phoneNumber, trainDate,
                modifyDateTime);
        if (!isAdd) {
